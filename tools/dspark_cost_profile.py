...
from tools.dspark_tooling import Server, exact_length_prompts, model_ref
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_false",
        help="profile the synchronous scheduler instead of the serving default",
    )
    ...
    prompts = {
        (context, count): exact_length_prompts(tokenizer, args.repo, context, count)
        for context in contexts
        for count in requests
    }
